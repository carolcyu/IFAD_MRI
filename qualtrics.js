Qualtrics.SurveyEngine.addOnload(function()
{
    ...
    // <<< SETTINGS: Make sure this points to your GitHub repository >>>
...
function initExp(){
    try {
        ...
        var jsPsych = initJsPsych({
            ...
            on_finish: function() {
                // <<< DATA SAVING: This is the corrected data saving part >>>
                var ifad_data = jsPsych.data.get().json();
                Qualtrics.SurveyEngine.setEmbeddedData("IFAD", ifad_data);
                
                // Clean up and move to the next Qualtrics question
                jQuery('#display_stage').remove();
                qthis.clickNextButton();
            }
        }); 
      
      // <<< EXPERIMENT TIMELINE: This is the timeline from your index.html file >>>
      var timeline = [];
