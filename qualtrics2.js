Qualtrics.SurveyEngine.addOnload(function()
{
    ...
    function initExp(){
        try {
            ...
            var MRIstart = { type: jsPsychHtmlKeyboardResponse, stimulus: "<p> Please wait while the scanner starts up. This will take 10 seconds. </strong></p>", choices: ['5'], prompt: "<p> A cross (+) will appear when the task starts. </p>", data: { task: 'mri_start' } };
            ...
            var fixation = { type: jsPsychHtmlKeyboardResponse, stimulus: '<div style="font-size:60px;">+</div>', choices: "NO_KEYS", trial_duration: 1000, data: { task: 'fixation' } };
            ...
            var response = { type: jsPsychHtmlKeyboardResponse, stimulus: "<p>How would you rate that symbol?</p>", choices: ['1', '2', '3','4'], trial_duration: 3000, response_ends_trial: false, data: { task: 'response' } };
